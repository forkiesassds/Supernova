...
namespace Supernova {
    public sealed partial class Server {
        ...
        public static Scheduler MainScheduler = new Scheduler("NOVA_MainScheduler");
        public static Scheduler Background = new Scheduler("NOVA_BackgroundScheduler");
        public static Scheduler Critical = new Scheduler("NOVA_CriticalScheduler");
        public static Server s = new Server();

        public static string salt = "";
        public static string betacraftSalt = "";
